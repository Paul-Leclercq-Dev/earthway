  ...
  plugins: [
    ...
    VitePWA({
      ...
      manifest: {
        ...
        short_name: 'Earthway',
        description: 'Plateforme de sensibilisation environnementale - Agissez pour la planète',
        theme_color: '#10b981',
      ...
      workbox: {
        ...
        // Navigation fallback - show offline page when offline
        navigateFallback: null, // Disable default fallback to handle manually
